using LanguageWise.QuestsAchievementsNotificationsService.Db.Data;
using LanguageWise.QuestsAchievementsNotificationsService.Db.Models;

const string ServiceName = "quests-achievements-notifications-service-db";

var builder = WebApplication.CreateBuilder(args);

// The database file lives on a named Docker volume so it survives container restarts.
var databasePath = builder.Configuration["Database:Path"] ?? "data/quests-achievements-notifications-service.db";
