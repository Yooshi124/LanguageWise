using LanguageWise.Student4.Db.Data;
using LanguageWise.Student4.Db.Models;

const string ServiceName = "student-4-db";

var builder = WebApplication.CreateBuilder(args);

// The database file lives on a named Docker volume so it survives container restarts.
var databasePath = builder.Configuration["Database:Path"] ?? "data/student-4.db";
