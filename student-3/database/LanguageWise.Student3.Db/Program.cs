using LanguageWise.Student3.Db.Data;
using LanguageWise.Student3.Db.Models;

const string ServiceName = "student-3-db";

var builder = WebApplication.CreateBuilder(args);

// The database file lives on a named Docker volume so it survives container restarts.
var databasePath = builder.Configuration["Database:Path"] ?? "data/student-3.db";
